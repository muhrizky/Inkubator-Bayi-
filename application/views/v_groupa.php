        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="dashboard_graph x_panel">
                  <div class="x_title">
                        <h2><b>Group Admin</b></h2>
                        
                        <div class="clearfix"></div>
                  </div>
                <div class="x_content">
                <div class="form-group text-left">
                  <a data-toggle="modal" data-target="#modaladd" class="btn btn-primary"> Tambah Group Admin </a>
		            </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td><?php echo $no++ ?></td>
                              <td><?php echo $lv->level ?></td>
                                <td>
                                <a 
                                href="javascript:;"
                                data-idlevel="<?php echo $lv->id_level ?>"
                                    ...
                                    <div class="modal-dialog modal-sm">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                          ...
                                          <h4 class="modal-title" id="myModalLabel"> Tambah Group Admin</h4>
                                        </div>
                                ...
                                <!-- end modal Edit -->
                                 <!-- modal hapus -->
                                 <?php foreach($level as $lv){ ?>
                                  <div class="modal fade"  id="modaldelete<?php echo $lv->id_level ?>" role="dialog" >
                                        <div class="modal-dialog modal-sm">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                              ...
                                              <a type="button" class="btn btn-default" <?php echo anchor('groupa/hapus_level/'.$lv->id_level,"Konfirmasi");?> </a>
                                            </div>
